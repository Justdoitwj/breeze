...
//            String address = "https://tcc.taobao.com/cc/json/mobile_tel_segment.htm";
            ...
            String address = "https://ms.kyeegroup.com/ms-hms/patientsCircles/doctors";
            String token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..8ZkVg0pOVlj1h5dCIlrpg4MZL3SL26hSfRZ1oGwp2Sc";
            //请求参数
            Map<String, String> params = new HashMap<String, String>();
//            params.put("tel", "13777777777");//这是该接口需要的参数
            params.put("hospitalId", "7730009");//这是该接口需要的参数
            Map<String, String> headparams = new HashMap<String, String>();
            headparams.put("Authorization", "Bearer " + token);
            // 调用 get 请求
//            String res = get(address, params, null);
            String res = proxyHttpRequest(address + "?"
                    + getRequestBody(params), "GET", headparams, null);
