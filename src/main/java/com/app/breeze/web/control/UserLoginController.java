...
//    @Limit(key = "USER:LOGIN", period = 10, count = 1000)
    public Callable<BreezeResponse> login(@RequestBody @Validated UserRequset userInfo) {
...
//    @PreventResubmitLock(prefix = "USER:REGISTER")
    ...
    public Callable<BreezeResponse>  register(@RequestBody UserRequset userInfo) {
